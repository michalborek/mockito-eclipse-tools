...
//	}
	...
	public static void assertNoMixedLineDelimiters(final IJavaElement elem) {
		IResource resource;
	...
	public static void assertNoMixedLineDelimiters(final IResource resource) {
		final IResource[] mixedResources= findFilesWithMixedLineDelimiters(resource);
